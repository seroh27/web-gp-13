...
class User(AbstractBaseUser):
    ...
    user_fname = models.CharField(max_length=15,null=True, blank=True)
    user_lname = models.CharField(max_length=15,null=True, blank=True)
    user_age = models.SmallIntegerField(validators=[MinValueValidator(12), MaxValueValidator(100)],null=True, blank=True)
    user_height_cm = models.SmallIntegerField(validators=[MinValueValidator(120), MaxValueValidator(250)],null=True, blank=True)
    user_weight_kg = models.FloatField(validators=[MinValueValidator(30), MaxValueValidator(150)],null=True, blank=True)
    user_activity_level = models.CharField(max_length=30,default=activity[1], choices=activity,null=True, blank=True)
