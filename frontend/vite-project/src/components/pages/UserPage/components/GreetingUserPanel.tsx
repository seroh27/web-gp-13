...
export default function Greeting() {
    ...
    return (
        <div className="container mx-auto sm:px-80 lg:px-70 pt-16 pb-8" dir="rtl">
            <div className="flex">
                <div className="self-center px-8 text-right">
                    <h4 style={{ fontSize: "24px" }} className="text-lg boldfont pb-2">به دایتلی خوش اومدی!</h4>
                    <p dir='rtl' className="mt-1 text-justify text-gray-600">
                        یه نکته برای رژیم گرفتنت: <br />
                        {randomText}
                    </p>
                </div>
                <div className="ml-4 flex-shrink-0">
                    <CircularProgress value={consumedCal} min={0} max={2500} size={150} strokeWidth={25} />
                </div>
            </div>
        </div>
    )
